...
public class Runner {
	...
	private static void exibirTodosClientes() {
		...
		ArrayList<Cliente> clientesFisicos = ClienteFisicoDAO.buscarTodosClientesFisicos();
		...
		ArrayList<Cliente> clientesJuridicos = ClienteJuridicoDAO.buscarTodosClientesJuridicos();
